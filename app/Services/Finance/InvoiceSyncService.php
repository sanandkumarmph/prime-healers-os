    ...
    public function createRentalInvoice(
        ...
        return DB::transaction(function () use (
            ...
            $invoice = Invoice::create([
                ...
                'bill_to_email' => $rental->billingContactEmail(),
                'bill_to_gstin' => $rental->usesBusinessPartnerFlow() ? ($rental->businessPartner?->gstin ?: null) : ($rental->customer?->gst_number ?: null),
