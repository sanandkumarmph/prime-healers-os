...
class Role extends Model
{
    ...
    public const SPECIAL_PERMISSIONS = [
        ...
        'finance.view_revenue' => 'View revenue amounts',
        'finance.view_dues' => 'View outstanding dues',
        'finance.view_payments' => 'View payment amounts',
        'finance.view_deposits' => 'View deposit amounts',
        'finance.view_profit' => 'View profit and margin amounts',
        'finance.view_transport' => 'View transport charge amounts',
        'finance.view_other_charges' => 'View other charge amounts',
        'finance.view_reports' => 'View finance reports',
        'dashboard.finance.full' => 'View full finance dashboard widgets',
