<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <x-nav-link :href="url('/rentals')" :active="request()->is('rentals*')">
        Rentals
    </x-nav-link>
    ...
    <x-responsive-nav-link :href="url('/rentals')" :active="request()->is('rentals*')">
        Rentals
    </x-responsive-nav-link>

    <x-responsive-nav-link :href="url('/customers')" :active="request()->is('customers*')">
        Customers
    </x-responsive-nav-link>
