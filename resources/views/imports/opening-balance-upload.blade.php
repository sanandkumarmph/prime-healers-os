        ...
        <section class="ph-import-card">
            ...
            <form method="POST" action="{{ route('imports.opening-balances.preview') }}" enctype="multipart/form-data" class="ph-import-upload-form">
                ...
                <label for="opening_balance_import_file" class="ph-import-dropzone">
                    ...
                    <span class="ph-import-dropzone-title">Choose opening balance file</span>
                    <span class="ph-import-dropzone-copy">Click to browse your CSV or XLSX file and review it before import.</span>
                    <input id="opening_balance_import_file" type="file" name="import_file" accept=".csv,.txt,.xlsx" required class="ph-import-file-input">
                </label>
                <div class="ph-import-file-note" id="opening-balance-import-file-name">No file selected yet.</div>
                @error('import_file')
...
document.addEventListener('DOMContentLoaded', function () {
    const input = document.getElementById('opening_balance_import_file');
    const fileName = document.getElementById('opening-balance-import-file-name');
